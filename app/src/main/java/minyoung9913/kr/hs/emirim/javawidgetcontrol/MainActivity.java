package minyoung9913.kr.hs.emirim.javawidgetcontrol;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text2.setTypeface(Typeface.MONOSPACE,Typeface.BOLD_ITALIC);

        text3.setText("Third TextView");
        text3.setTextSize(10);
        text3.setTypeface(Typeface.SANS_SERIF,Typeface.BOLD);
